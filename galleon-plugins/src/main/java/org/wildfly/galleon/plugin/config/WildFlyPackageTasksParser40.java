...
import static org.wildfly.galleon.plugin.config.WildFlyPackageTasksParser.NAMESPACE_4_0;
 ...
 */
class WildFlyPackageTasksParser40 implements XMLElementReader<WildFlyPackageTasks.Builder> {
    ...
    enum Element {
        ...
        static {
            ...
            elementsMap.put(new QName(NAMESPACE_4_0, Element.CONFIG.getLocalName()), Element.CONFIG);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.COPY_ARTIFACT.getLocalName()), Element.COPY_ARTIFACT);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.ASSEMBLE_SHADED_ARTIFACT.getLocalName()), Element.ASSEMBLE_SHADED_ARTIFACT);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.COPY_PATH.getLocalName()), Element.COPY_PATH);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.DELETE.getLocalName()), Element.DELETE);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.EXAMPLE_CONFIGS.getLocalName()), Element.EXAMPLE_CONFIGS);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.FILE_APPENDER.getLocalName()), Element.FILE_APPENDER);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.FILE_PERMISSIONS.getLocalName()), Element.FILE_PERMISSIONS);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.FILTER.getLocalName()), Element.FILTER);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.LINE.getLocalName()), Element.LINE);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.LINE_ENDINGS.getLocalName()), Element.LINE_ENDINGS);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.MKDIR.getLocalName()), Element.MKDIR);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.PARAM.getLocalName()), Element.PARAM);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.PARAMS.getLocalName()), Element.PARAMS);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.PERMISSION.getLocalName()), Element.PERMISSION);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.TASKS.getLocalName()), Element.TASKS);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.TRANSFORM.getLocalName()), Element.TRANSFORM);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.UNIX.getLocalName()), Element.UNIX);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.WINDOWS.getLocalName()), Element.WINDOWS);
            elementsMap.put(new QName(NAMESPACE_4_0, Element.XML_MERGE.getLocalName()), Element.XML_MERGE);
        ...
        static Element of(QName qName) {
            ...
            if (qName.getNamespaceURI().equals("")) {
                name = new QName(NAMESPACE_4_0, qName.getLocalPart());
            } else {
                name = qName;
            }
