...
import static org.wildfly.galleon.plugin.config.WildFlyPackageTasksParser.NAMESPACE_3_3;
 ...
 */
class WildFlyPackageTasksParser33 implements XMLElementReader<WildFlyPackageTasks.Builder> {
    ...
    enum Element {
        ...
        FILTER("filter"),
        GENERATE_LOGGING("generate-logging"),
        LINE("line"),
        ...
        static {
            ...
            elementsMap.put(new QName(NAMESPACE_3_3, Element.ASSEMBLE_SHADED_ARTIFACT.getLocalName()), Element.ASSEMBLE_SHADED_ARTIFACT);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.CONFIG.getLocalName()), Element.CONFIG);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.COPY_ARTIFACT.getLocalName()), Element.COPY_ARTIFACT);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.COPY_PATH.getLocalName()), Element.COPY_PATH);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.DELETE.getLocalName()), Element.DELETE);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.EXAMPLE_CONFIGS.getLocalName()), Element.EXAMPLE_CONFIGS);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.FILE_APPENDER.getLocalName()), Element.FILE_APPENDER);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.FILE_PERMISSIONS.getLocalName()), Element.FILE_PERMISSIONS);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.FILTER.getLocalName()), Element.FILTER);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.GENERATE_LOGGING.getLocalName()), Element.GENERATE_LOGGING);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.LINE.getLocalName()), Element.LINE);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.LINE_ENDINGS.getLocalName()), Element.LINE_ENDINGS);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.MKDIR.getLocalName()), Element.MKDIR);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.PARAM.getLocalName()), Element.PARAM);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.PARAMS.getLocalName()), Element.PARAMS);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.PERMISSION.getLocalName()), Element.PERMISSION);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.TASKS.getLocalName()), Element.TASKS);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.TRANSFORM.getLocalName()), Element.TRANSFORM);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.UNIX.getLocalName()), Element.UNIX);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.WINDOWS.getLocalName()), Element.WINDOWS);
            elementsMap.put(new QName(NAMESPACE_3_3, Element.XML_MERGE.getLocalName()), Element.XML_MERGE);
        ...
        static Element of(QName qName) {
            ...
            if (qName.getNamespaceURI().equals("")) {
                name = new QName(NAMESPACE_3_3, qName.getLocalPart());
            } else {
                name = qName;
            }
                ...
                case XMLStreamConstants.START_ELEMENT: {
                    ...
                    switch (element) {
                        ...
                        case GENERATE_LOGGING:
                            builder.addTask(parseGenerateLogging(reader));
                            break;
                        case TRANSFORM:
    ...
    private GenerateLogging parseGenerateLogging(XMLStreamReader reader) throws XMLStreamException {
        final GenerateLogging builder = new GenerateLogging();
        final Set<Attribute> required = EnumSet.of(Attribute.ARTIFACT, Attribute.TO_LOCATION);
        final int count = reader.getAttributeCount();
        for (int i = 0; i < count; i++) {
            final Attribute attribute = Attribute.of(reader.getAttributeName(i));
