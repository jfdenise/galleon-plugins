 ...
 */
public class GenerateLogging implements WildFlyPackageTask {
    ...
    public void execute(WfInstallPlugin plugin, PackageRuntime pkg) throws ProvisioningException {
        try {
            plugin.generateLogging(this, pkg);
        } catch (ProvisioningException e) {
            throw new ProvisioningException("Failed to execute logging class generation task of feature-pack " + pkg.getFeaturePackRuntime().getFPID() +
