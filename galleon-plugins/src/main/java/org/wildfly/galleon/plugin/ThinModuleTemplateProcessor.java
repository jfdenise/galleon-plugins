...
/**
 * A Template processor that process templates when provisioning thin server. In this case
 * module.xml artifacts are updated with a version.
 *
 * @author jdenise
 */
class ThinModuleTemplateProcessor extends ModuleTemplateProcessor {

    ThinModuleTemplateProcessor(WfInstallPlugin plugin,
            ModuleArtifactInstaller installer, Path targetPath, ModuleTemplate template, Map<String, String> versionProps) {
