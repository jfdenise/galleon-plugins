...
public class WildFlyPackageTasksParser {
    ...
    public static final String NAMESPACE_3_3 = "urn:wildfly:wildfly-feature-pack-tasks:3.3";
    ...
    private static final QName ROOT_3_3 = new QName(NAMESPACE_3_3, WildFlyPackageTasksParser33.Element.TASKS.getLocalName());
    ...
    public WildFlyPackageTasksParser() {
        ...
        mapper.registerRootElement(ROOT_3_3, new WildFlyPackageTasksParser33());
