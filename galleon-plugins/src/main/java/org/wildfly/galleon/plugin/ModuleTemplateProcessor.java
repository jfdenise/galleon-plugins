...
/**
 * Abstract template processor that implements logic common to fat and thin server.
 *
 * @author jdenise
 */
abstract class ModuleTemplateProcessor {
    ...
    private final ModuleArtifactInstaller installer;
    private final Path targetDir;

    ModuleTemplateProcessor(WfInstallPlugin plugin, ModuleArtifactInstaller installer, Path targetPath, ModuleTemplate template, Map<String, String> versionProps) {
    ...
    ModuleArtifactInstaller getInstaller() {
        return installer;
    }
