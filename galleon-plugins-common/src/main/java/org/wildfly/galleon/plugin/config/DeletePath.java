...
import org.wildfly.galleon.plugin.AbstractWfInstallPlugin;
...
public class DeletePath implements WildFlyPackageTask {
    ...
    @Override
    public void execute(AbstractWfInstallPlugin plugin, PackageRuntime pkg) throws ProvisioningException {
