...
abstract class AbstractModuleTemplateProcessor {
    ...
    private final Map<String, String> versionProps;
    private final AbstractWfInstallPlugin plugin;
    private final AbstractArtifactInstaller installer;
    private final Path targetDir;
    private final boolean channelArtifactResolution;

    AbstractModuleTemplateProcessor(AbstractWfInstallPlugin plugin, AbstractArtifactInstaller installer, Path targetPath,
    ...
    AbstractWfInstallPlugin getPlugin() {
        return plugin;
    }
