...
public class FeatureSpecGenerator implements ForkCallback {
    ...
    private void doGenerate() throws ProvisioningException {
        ...
        if (fork) {
            ...
            ForkedEmbeddedUtil.fork(this, getStoredSystemProps(), installation, getStandaloneSpecsFile().toString(), getDomainSpecsFile().toString(), description , generateCompleteModel ? "true" : "false", minStab);
